...
Totp.prototype.createToken = function (data) {
	...
	let c = Math.floor(counterTime /step/1000);
	let b1 = Buffer.alloc(8);
	b1.writeInt32BE(c,4);

	return OTP.prototype.tokenize.call(this,{counter: b1,secret: data.secret,num_digits: data.num_digits,algorithm: data.algorithm,step: data.step});
};
